...
contract CvcProxy is ImplementationStorage {
    ...
    bytes32 private constant ADMIN_SLOT =
        0x2bbac3e52eee27be250d682577104e2abe776c40160cd3167b24633933100433;
    ...
    function changeAdmin(address _newAdmin) external ifAdmin {
        require(
            _newAdmin != address(0),
            "Cannot change contract admin to zero address"
        );
        ...
        ifAdmin
    {
        ...
        require(
            ...
            "Upgrade error: initialization method call failed"
        );
    }
    ...
    function upgradeImplementation(address _newImplementation) private {
        ...
        require(
            ...
            "Upgrade error: proxy contract already uses specified implementation"
        );
